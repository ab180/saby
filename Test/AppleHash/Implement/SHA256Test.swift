...
import XCTest
@testable import SabyAppleHash

final class SHA256Test: XCTestCase {
    func test__hash_string() {
        XCTAssertEqual(
            SHA256.hash(string: "test"),
        ...
        XCTAssertEqual(
            SHA256.hash(string: "https://:password@airbridge.io/"),
        ...
        XCTAssertEqual(
            SHA256.hash(string: "https://airbridge.io/path/"),
